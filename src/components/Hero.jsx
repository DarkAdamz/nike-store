...
import ShoeCard from "../UI assets/ShoeCard";
...
const Hero = () => {
  ...
  return (
//Always use HTML Sematic tags 
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container border-2"
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 ps-10">
